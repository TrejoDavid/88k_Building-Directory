...
function loadTransit(){
  $.ajax({
    type: "GET",
    url: ["http://api.bart.gov/api/etd.aspx?cmd=etd&orig=POWL&key=MW9S-E7SL-26DU-VV8V"],
    dataType: "xml",
    success: function (xml) {
        ...
        $("#outboundData3 tbody, #inboundData3 tbody").empty();
